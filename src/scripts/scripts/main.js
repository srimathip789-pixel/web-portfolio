...
function createProjectCard(project) {
    ...
    const gifSrc = project.gif ?? 'assets/project-placeholder.gif';
...
function loadSkillsFromData(skills) {
...
function loadExperienceFromData(experience = []) {
...
function loadEducationFromData(education = []) {
